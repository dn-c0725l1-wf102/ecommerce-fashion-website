    ...
    return (
        <main className="contactspage">
            ...
            <div className="shop-link">
                <h2 className='shop-name'>Ecommerce-fashion</h2>
                <p className='shop-title'>
                    Ecommerce-fashion Cửa hàng thời trang lớn và uy tín nhất tại Hà Nội. Chuyên cung cấp các mặt hàng về quần, áo, váy, đầm hay các phụ kiện trang sức như túi, khăn tay, dây chuyền... Đến với chúng tôi là đến với những chuyên gia, bạn sẽ được trải nghiệm mọi thứ như một nhà mua sắm chuyên nghiệp, được phục vụ tân tâm và luôn mang lại sản phẩm chất lượng nhất cho bạn.    
                </p>
                <p>
                    <b>Facebook: </b>
                ...
                <p>
                    ...
                    <u onClick={()=> nav('/address')} className='pointer'>Hệ thống cửa hàng Ecommerce-fashion trên toàn quốc</u>
                </p>
            </div>
        </main>
    )
