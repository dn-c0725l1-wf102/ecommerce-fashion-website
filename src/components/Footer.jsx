        ...
        <footer className="footer">
            ...
            <section className="footer_mid">
                <div className="footer_mid_contacts">
                    <h5>Liên hệ</h5>
                    <p>Hotline: 0989.872.428</p>
                    <p>Địa chỉ: Phố nhà 17 , ngách 20 , Hai Bà Trưng , Hà Nội</p>
                    <p>Liên hệ: 0989.872.428</p>
                    <p>Zalo: 0989.872.428</p>
                    <p>Email: nguyenminhmai2@gmail.com</p>
                </div>
            ...
            <section className="footer_bot">
                <p>Bản quyền thuộc về Công Ty TNHH Thời Trang EF</p>
            </section>
        </footer>
    )
}
